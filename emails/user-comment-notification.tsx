...
interface UserCommentNotificationProps {
  clientName: string;
  clientEmail: string;
  comment: string;
  calendarDate: string;
...
export function UserCommentNotification({
  clientName,
  clientEmail,
  comment,
  calendarDate,
  calendarItem,
  dashboardUrl,
}: UserCommentNotificationProps) {
  return (
    <Html>
      <Head />
      <Preview>New comment from {clientName} on calendar item</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Heading style={h1}>MOIL Calendar - New Comment</Heading>
          </Section>
          
          <Section style={content}>
            <Text style={paragraph}>
              <strong>{clientName}</strong> left a comment on their calendar item for <strong>{calendarDate}</strong>.
            </Text>
